...
export default function PremiumSection({ goBack, previousLabel, setActiveSection }: Props) {
  ...
  const handleUnlock = () => {
    ...
    const link = selectedPlan === "standard" ? WHOP_STANDARD_LINK : WHOP_PREMIUM_LINK;
    ...
    <div className="min-h-screen bg-slate-900 py-20 px-4 pt-24">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          ...
          >
            <div className="flex items-center justify-between mb-3">
              ...
              {selectedPlan === "standard" && <span className="bg-blue-500/20 text-blue-400 text-xs px-2 py-0.5 rounded-full border border-blue-500/30">Selected</span>}
            </div>
          ...
          >
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              {selectedPlan === "premium" && <span className="bg-amber-500/20 text-amber-400 text-xs px-2 py-0.5 rounded-full border border-amber-500/30">Selected</span>}
            </div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 mb-10">
          ...
          >
            {termsAccepted && privacyAccepted
              ? `Subscribe to ${selectedPlan === "standard" ? "Standard — $15/month" : "Premium — $25/month"} →`
