        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-8 space-y-8 text-slate-300 text-sm leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-none space-y-2 pl-4">
              ...
              <li className="flex items-start gap-2"><span className="text-amber-400 mt-1">◆</span> If — and only if — you accept analytics cookies, usage analytics are processed by <strong className="text-white">PostHog</strong> (EU region). This records pages viewed and actions such as starting a checkout, so we can see where the product confuses people. It does not record your CV content or your interview answers. If you decline analytics cookies, PostHog is never loaded at all. You can change your choice at any time via the cookie banner.</li>
              <li className="flex items-start gap-2"><span className="text-amber-400 mt-1">◆</span> Technical error reports are processed by <strong className="text-white">Sentry</strong> so we can detect and fix crashes (for example a failed payment or signup). These reports contain technical diagnostics only — no personal data is attached.</li>
