      ...
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden" style={{backgroundImage:"url(/images/hero-bg.jpg)",backgroundSize:"cover",backgroundPosition:"center"}}>
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto pt-16">
          <div className="inline-flex items-center gap-2 bg-amber-500/20 border border-amber-500/40 rounded-full px-4 py-2 mb-6 backdrop-blur-sm">
            ...
            <span className="text-amber-300 text-xs sm:text-sm font-medium">Middle Eastern Airlines Edition 2025-2026</span>
            <span className="text-amber-400 text-sm">✦</span>
          </div>
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-white mb-3 font-light">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-slate-400 text-sm leading-relaxed">
                  Practice with a simulated AI recruiter from Emirates, Qatar Airways, Etihad, flydubai or Air Arabia. Get instant feedback on every answer.
                </p>
            ...
            >
              ...
              <div className="relative">
                ...
                <h3 className="text-white font-bold text-lg md:text-xl mb-2">AI CV Review</h3>
                <p className="text-slate-400 text-sm leading-relaxed">
                  Paste your CV and get instant AI-powered feedback tailored to cabin crew standards at ME airlines.
                </p>
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-slate-400 text-sm leading-relaxed">
                  Find out exactly why Emirates, Qatar Airways, Etihad, flydubai or Air Arabia rejected you — and how to fix it before you reapply.
                </p>
            ...
            <button
              onClick={() => setActiveSection("after-interview")}
              className="group relative bg-gradient-to-br from-blue-900/40 to-slate-800 border border-blue-500/40 p-5 md:p-6 rounded-2xl hover:scale-[1.02] transition-all duration-300 shadow-lg text-left overflow-hidden"
            >
              ...
              <div className="relative">
                ...
                <h3 className="text-white font-bold text-lg md:text-xl mb-2">After the Interview</h3>
                <p className="text-slate-400 text-sm leading-relaxed">
                  The silence, the medical, the DOJ wait, and what to do if it doesn't go your way — the part no competitor covers.
                </p>
                <div className="mt-4 text-blue-400 text-sm font-semibold group-hover:gap-2 flex items-center gap-1 transition-all">
                  What happens next →
                </div>
              </div>
            </button>
          ...
          <div className="mt-12 md:mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {[
              ...
              { value: "45", label: "Practice Questions", icon: "💬" },
