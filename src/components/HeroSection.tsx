        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-8 flex flex-col items-center gap-4">
            ...
            >
              ...
              <div className="relative flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-5">
                <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-blue-600/30 border border-blue-500/30 flex items-center justify-center flex-shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 md:w-8 md:h-8 text-blue-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
