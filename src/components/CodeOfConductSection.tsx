      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">
            Understanding the professional standards expected of cabin crew before your interview shows
            recruiters you're already thinking like a crew member.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-amber-500/20 via-yellow-500/10 to-amber-500/20 border border-amber-500/30 rounded-2xl p-6 mb-12">
          <h4 className="text-amber-400 font-bold text-lg mb-4 text-center">
            ✦ The Three Pillars of Cabin Crew Excellence ✦
          </h4>
            ...
            {[
              {
                pillar: "Safety",
                icon: "🛡️",
                desc: "Safety is ALWAYS the top priority — above service, comfort, and convenience. Every decision made on board starts here.",
              ...
              },
              {
                pillar: "Service",
                icon: "⭐",
                desc: "Deliver exceptional, personalised service that exceeds passenger expectations at every interaction.",
              ...
              },
              {
                pillar: "Integrity",
                icon: "💎",
                desc: "Uphold the highest standards of professionalism, honesty, and ethical behaviour at all times.",
              ...
              <div
                key={pillar.pillar}
                className={`bg-gradient-to-br ${pillar.color} border ${pillar.border} rounded-xl p-5 text-center`}
              >
        ...
        <div className="bg-gradient-to-r from-amber-900/30 to-slate-800 border border-amber-500/20 rounded-2xl p-8 text-center">
          ...
          <p className="text-white text-xl font-light italic leading-relaxed mb-4">
            You are not just cabin crew — you are an ambassador of your airline, your country, and the aviation industry.
          </p>
          <p className="text-amber-400 font-semibold text-sm">A guiding principle for aviation professionals worldwide</p>
        </div>
